    ...
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        ...
        <p>
          ...
          praesentium debitis iste expedita vel sapiente, sequi neque fugit quia
          aperiam deleniti architecto ipsum perferendis officiis, perspiciatis
          iure. Perspiciatis, non voluptas ipsum minus tempora labore, a veniam
          sed, atque modi pariatur.
        </p>
      </div>
    </div>
  );
